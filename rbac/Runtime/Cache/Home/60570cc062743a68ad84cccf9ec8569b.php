...
</script><script src="/Components/rbac/Public/statics/emoji/js/config.js"></script><script src="/Components/rbac/Public/statics/emoji/js/emoji-picker.js"></script><script src="/Components/rbac/Public/statics/emoji/js/jquery.emojiarea.js"></script><script src="http://cdn.ronghub.com/RongIMLib-2.0.6.beta.min.js"></script><script src="/Components/rbac/Public/statics/rongcloud/js/RongEmoji-2.0.2.beta.min.js"></script><script src="/Components/rbac/Public/statics/rongcloud/js/main.js"></script><script src="/Components/rbac/tpl/Public/js/base.js"></script><script>
$(function(){
    // 初始化emoji
    window.emojiPicker = new EmojiPicker({
        emojiable_selector: '[data-emojiable=true]',
        assetsPath: '/Components/rbac/Public/statics/emoji/images',
        'iconSize': 20
    });
