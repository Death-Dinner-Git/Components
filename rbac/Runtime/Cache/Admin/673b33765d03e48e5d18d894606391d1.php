<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><title>权限管理 - bjyadmin</title>    <meta http-equiv="Cache-Control" content="no-transform" />
